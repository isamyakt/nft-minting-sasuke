import { initializeKeypair } from "./initializerKeypair"
...
const tokenName = "Sasuke Uchiha";
const description = "Last and strongest member of Uchiha Clan";
const symbol = "SSK";
const sellerFeeBasisPoints = 100;
const imageFile = "uchihasasuke.png"
...
// upload image
  ...
  // uploag metadata and get metadata uri (off chain metadata)
  ...
  // 
  const mintAddress = new PublicKey("2uAaeLVjQo1URGL3hx3wAMXw4dUJw4g6HXgUj9YjbkHH");
